                    ...
                    <div className={"section"}>
                        ...
                        <div className={"serviceCases"}>
                            <div className={"service"}>
                                <Image className={"gearIcon"} src={gearIcon} alt={"Icon"} width={44} height={44}/>
                ...
                <div className={"industrySection section"}>
                    ...
                    <div className={"industries container"}>
                        <div className={"industry"}>
                            <Image src={healthcare} alt={"icon"} className={"industryIcon"} width={103} height={103}/>
                            <p className={"title"}>Healthcare</p>
                        </div>
                        <div className={"industry"}>
                            <Image src={realEstate} alt={"icon"} className={"industryIcon"} width={103} height={103}/>
                            <p className={"title"}>Real estate</p>
                        </div>
                        <div className={"industry"}>
                            <Image src={telecom} alt={"icon"} className={"industryIcon"} width={103} height={103}/>
                            <p className={"title"}>Telecom</p>
                        </div>
                        <div className={"industry"}>
                            <Image src={automotive} alt={"icon"} className={"industryIcon"} width={103} height={103}/>
                            <p className={"title"}>Automotive</p>
                        </div>
                        <div className={"industry"}>
                            <Image src={construction} alt={"icon"} className={"industryIcon"} width={103} height={103}/>
                            <p className={"title"}>Construction</p>
                        </div>
                        <div className={"industry"}>
                            <Image src={propM} alt={"icon"} className={"industryIcon"} width={103} height={103}/>
                            <p className={"title"}>Property <br/> management</p>
                        </div>
                        <div className={"industry"}>
                            <Image src={energy} alt={"icon"} className={"industryIcon"} width={103} height={103}/>
                            <p className={"title"}>energy sector</p>
                        </div>
                        <div className={"industry"}>
                            <Image src={banking} alt={"icon"} className={"industryIcon"} width={103} height={103}/>
