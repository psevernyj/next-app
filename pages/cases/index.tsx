            ...
            <main className={"main casesPage"}>
                <div className={"firstScreen"}>
                    <div className={"content container"}>
                        <h1 className={"title"}>UDS mission is to free our clients from cliches and routines</h1>
                        <p className={"subtitle"}>Since 2007, we have been implementing boosting and supporting projects
                            for companies worldwide. Take a look at some happy episodes of business flows
                            transformation.</p>
                    </div>
                </div>
