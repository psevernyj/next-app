        ...
        <div className={"popularAddons section"}>
            ...
            <div className={"addOns container"}>
                <div className={"addOn"}>
                    ...
                    <span className={"downloadsInfo"}>3 354 <span className={"inscription"}>downloads</span></span>
                </div>
                <div className={"addOn"}>
                    <p className={"title"}>Migration Calculator</p>
                    <Image src={mc} alt={"Icon"} width={120} height={96}/>
                    <span className={"downloadsInfo"}>983 <span className={"inscription"}>downloads</span></span>
                </div>
                <div className={"addOn"}>
