            ...
            <div className={"articleCards container"}>
                <div className={"card"}>
                    <div className={"imageContent"}>
                        <Image className={"thumbnail"} src={logo1} alt={"Article thumbnail"}/>
                        <Image className={"icon"} src={icon} alt={"Article icon"} width={20} height={20}/>
                    </div>
                ...
                <div className={"card"}>
                    <div className={"imageContent"}>
                        <Image className={"thumbnail"} src={logo2} alt={"Article thumbnail"}/>
                        <Image className={"icon"} src={icon} alt={"Article icon"} width={20} height={20}/>
                    </div>
                    <div className={"content"}>
                ...
                <div className={"card"}>
                    <div className={"imageContent"}>
                        <Image className={"thumbnail"} src={logo3} alt={"Article thumbnail"}/>
                        <Image className={"icon"} src={icon} alt={"Article icon"} width={20} height={20}/>
                    </div>
                    <div className={"content"}>
                        <p className={"publicDate"}>November 18, 2021</p>
                        <p className={"title"}>
                            How To Become MS Dynamics 365 Consultant
                        </p>
                        <div className={"actions"}>
                            <Tag text={"Education"}/>
                            <button className={"arrowButton"}>
                ...
                <div className={"card"}>
                    <div className={"imageContent"}>
                        <Image className={"thumbnail"} src={logo4} alt={"Article thumbnail"}/>
                        <Image className={"icon"} src={icon} alt={"Article icon"} width={20} height={20}/>
                    </div>
                    <div className={"content"}>
