                ...
                <div className={"linksSection"}>
                    ...
                    <div className={"links"}>
                        <div className={"column"}>
                            ...
                            <Link href={"/cases"} className={"link"}>Our Cases</Link>
                            <Link href={"/add-ons"} className={"link"}>Add-ons</Link>
                        </div>
                        <div className={"column"}>
                ...
                <div className={"contacts"}>
                    ...
                    <div className={"column"}>
                        ...
                        <div className={"contact"}>
                            ...
                            <a href="mailto:info@uds.systems" className={"link"}>info@uds.systems</a>
                        </div>
                        <div className={"contact"}>
                            <Image src={skype} alt={"skype"}/>
                            <a href="skype:live:uds_ddt?chat" className={"link"}>uds.systems</a>
                        </div>
                    </div>
                </div>
            ...
            <div className={"subFooter"}>
                <div className={"container content"}>
                    <div className={"rights"}>
                        <p className={"rightsTitle"}>UDS Systems © 2022 All Rights reserved</p>
